...
class SuperCalendar(models.Model):
    ...
    configurator_id = fields.Many2one('super.calendar.configurator', string='Configurator', readonly=True,)
    res_id = fields.Reference(selection=_models_get, string='Resource', readonly=True,)
